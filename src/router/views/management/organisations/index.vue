                            ...
                            <tbody>
                                ...
                                <tr v-for="org in orgs"
                                    ...
                                    <td class="px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        ...
                                        <button @click.prevent.stop="drawerOrg?.edit(org)" id="dropdownDividerButton"
                                            type="button" data-dropdown-toggle="dropdownDivider" class="btn-unstate">
                                            Editer
                                        </button>
...
// import ListOrganisations from './ListOrganisation.vue'
